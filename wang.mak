...
LOCAL_OPT=$(subst ___~~~___, ,$(subst $(notdir $<)___,,$(filter $(notdir\
	$<)___%,$(LOCAL_OPTIONS))))
OBJFILES=circlebres.o draw.o linebres.o list.o rubber.o transforms.o\
	wangtest.o
LIBRARIES=
SOURCE_NAME=$<
OUTFILE=$@
...
MAIN_TARGET=wang.exe
PROJECT_ITEMS=circlebres.c draw.c linebres.c list.c rubber.c transforms.c\
	wangtest.c
...
%.s: %.C
	$(RHIDE_COMPILE.C.s)
all::
DEPS_0= circlebres.o draw.o linebres.o list.o rubber.o transforms.o\
	wangtest.o 
NO_LINK=
